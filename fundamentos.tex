...
\end{minted}
    ...
    Donde \mintinline{python}|<condición>| es una \alert{expresión booleana} y \mintinline{python}|<sentencias_a_repetir>| (indentada con respecto a \mintinline{python}|while|) es la secuencia de instrucciones a repetir. Con esto, se repiten las \mintinline{python}|<sentencias_a_repetir>| mientras se cumpla la \mintinline{python}|condición| señalada.
...
\begin{contentbox}{label=Función \mintinline{python}|range|}
    ...
    \begin{itemize}
        ...
        \item \mintinline{python}|range(start, stop, step)| genera números desde \texttt{start} hasta \texttt{stop-1}, con distancia de \texttt{step} entre ellos.
    \end{itemize}
