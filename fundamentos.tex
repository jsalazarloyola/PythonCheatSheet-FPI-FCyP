...
\begin{contentbox}{label=Operaciones Básicas}
    \begin{tabular}{C|p{0.5\linewidth}}
        ...
        \mintinline{python}|print(valor,...)| & Muestra por pantalla los \mintinline{python}|valores| separados por coma \\
...
\begin{contentbox}{label=Strings}
    \begin{tabular}{C|p{0.5\linewidth}}
        ...
        % 
        \mintinline{python}|s.capitalize()| & Retorna el string convertido con el primer caracter a mayúscula, si es una letra, y el resto a minúscula. \\
...
\begin{contentbox}{label=Consultas sobre Strings}
    ...
    \begin{tabular}{C|p{0.5\linewidth}}
        ...
        \mintinline{python}|s.isalpha()| & Todos los caracteres son alfabéticos. \\
        \mintinline{python}|s.isdigit()| & Todos los caracteres son dígitos. \\
        \mintinline{python}|s.isalnum()| & Todos los caracteres son alfabéticos o dígitos. \\
...
\end{minted}
    ...
    Donde \mintinline{python}|<condición>| es una \alert{expresión booleana} y \mintinline{python}|<sentencias_a_repetir>| (última instrucción indentada con respecto a \mintinline{python}|while|) es la secuencia de instrucciones a repetir.
...
\end{minted}
    ...
    Entre las secuencias, se incluyen archivos, \mintinline{python}|list|, \mintinline{python}|str|, \mintinline{python}|range|, etc.
\end{contentbox}
...
\begin{contentbox}{label=\textit{Slices} y Copias}
    ...
    \end{center}
    retornando un objeto del mismo tipo del seccionado, con \mintinline{python}|a| el índice inicial del corte, \mintinline{python}|b| el índice final (él último índice retornado será siempre el mayor valor posible menor a \mintinline{python}|b|) y \mintinline{python}|c| la distancia entre dos elementos consecutivos recuperados. \mintinline{python}|a| y \mintinline{python}|b| deben ser índices válidos y \mintinline{python}|c| debe ser un número entero (positivo o negativo).
...
\begin{contentbox}{label=Listas}
    \begin{tabular}{C|p{0.5\linewidth}}
        \mintinline{python}|lista = [1, 2, 3]| & Define un objeto de tipo lista. \\
        \mintinline{python}|lista[i]| & Retorna el elemento en la posición \mintinline{python}|i|. Soporta de \mintinline{python}|0| a \mintinline{python}|n-1|\footnote{Con \mintinline{python}|n| equivalente al largo de la lista.} de izquierda a derecha y de \mintinline{python}|-1| a \mintinline{python}|-n| de derecha a izquierda. \\
